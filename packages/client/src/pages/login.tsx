...
export default function Login() {
  ...
  return (
    <>
      <Head>
        <title>Sign In - TaskSync</title>
        <meta
          name="description"
          content="Sign in to TaskSync to manage your collaborative task boards and projects"
        />
        <meta property="og:title" content="Sign In - TaskSync" />
        <meta
